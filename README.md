...
- **Performance Presets** - Quick switch between Download (5W), Silent (15W), Performance (25W), and Turbo (35W) modes
- **TDP Override** - Manually set TDP from 5W to 35W with fine-grained control
